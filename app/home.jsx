...
class Home extends Component {
  ...
  render() {
    ...
    const todayTasks = allTasks.filter(task => task.dueDate === todayFormatted);
    const completed = todayTasks.filter(t => t.checked).length;
      ...
      <View style={styles.container}>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.taskContainer}>
            ...
            <ScrollView>
              {todayTasks.length === 0 ? (
                <Text style={styles.noTasks}>No tasks for today. Add some in the Checklist!</Text>
              ) : (
                todayTasks.map(task => (
